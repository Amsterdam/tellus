...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('tellus_data', '0003_materialized_view_tellingen_length'),
    ]

    operations = [
        migrations.RunSQL("""
DROP MATERIALIZED VIEW IF EXISTS "tellus_data_cars_per_hour_speed";
CREATE MATERIALIZED VIEW tellus_data_cars_per_hour_speed
  AS
    SELECT
           ROW_NUMBER() OVER (ORDER BY 1) as id,
           tellus.id as tellus_id,
           telling.snelheids_interval_id,
    ...
    ORDER BY tellus.id,
             ...
             tijd_van
WITH DATA;
CREATE UNIQUE INDEX tellus_data_cars_per_hour_speed_pkey ON tellus_data_cars_per_hour_speed(id); 
        """, """
DROP MATERIALIZED VIEW IF EXISTS "tellus_data_cars_per_hour_speed";
        """),
    ]
