...
urlpatterns = [
    ...
    url(r'^meetraaicategorie/$', views.MeetraaiCategorieList.as_view(), name='meetraaicategorie-list'),
    url(r'^meetraaicategorie/(?P<pk>[0-9]+)/', views.MeetraaiCategorieDetail.as_view(), name='meetraaicategorie-detail'),
    url(r'^representatiefcategorie/$', views.RepresentatiefCategorieList.as_view(), name='representatiefcategorie-list'),
    url(r'^representatiefcategorie/(?P<pk>[0-9]+)/', views.RepresentatiefCategorieDetail.as_view(), name='representatiefcategorie-detail'),
    url(r'^validatiecategorie/$', views.ValidatieCategorieList.as_view(), name='validatiecategorie-list'),
    url(r'^validatiecategorie/(?P<pk>[0-9]+)/', views.ValidatieCategorieDetail.as_view(), name='validatiecategorie-detail'),
