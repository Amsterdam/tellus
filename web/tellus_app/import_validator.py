...
def check_import():
    ...
    assert_count(0, TellingCarsPerHourPerDay.objects.count(), 'TellingCarsPerHourPerDay count')
    # assert_count(4 * 1000 * 1000, TellingCarsPerHourLength.objects.count(), 'TellingCarsPerHourLength count')
    assert_count(0, TellingCarsPerHourLength.objects.count(), 'TellingCarsPerHourLength count')
    # assert_count(7 * 1000 * 1000, TellingCarsPerHourSpeed.objects.count(), 'TellingCarsPerHourSpeed count')
    assert_count(0, TellingCarsPerHourSpeed.objects.count(), 'TellingCarsPerHourSpeed count')
    # assert_count(45 * 1000, TellingCarsYMH.objects.count(), 'TellingCarsYMH count')
    assert_count(0, TellingCarsYMH.objects.count(), 'TellingCarsYMH count')
    # assert_count(250 * 1000, TellingCarsYMHLength.objects.count(), 'TellingCarsYMHLength count')
    assert_count(0, TellingCarsYMHLength.objects.count(), 'TellingCarsYMHLength count')
    # assert_count(450 * 1000, TellingCarsYMHSpeed.objects.count(), 'TellingCarsYMHSpeed count')
    assert_count(0, TellingCarsYMHSpeed.objects.count(), 'TellingCarsYMHSpeed count')
